...
public class EmployeeRunner {
	...
	EmployeeDto dto = new EmployeeDto(9, "SheelaGolsangi", "Manager", "4-5-2023", 3.3f, "Shivamogga", "BE", 24,
		...
		EmployeeDto dto5 = new EmployeeDto(8, "Aman", "ChiefInformationOfficer", "10-5-2023", 3.3f, "Rajasthan", "MSE",
				24, Gender.Female, 12345678901L);

		EmployeeService service = context.getBean(EmployeeServiceImpl.class);
		
   	service.fingByName(dto.getName());
